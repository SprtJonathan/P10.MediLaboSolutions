...
public class PatientsController : Controller
{
    ...
    public async Task<ActionResult> Details(int id)
    {
        try
        {
            ...
            var viewModel = new PatientDetailsViewModel
            {
                ...
                NiveauRisqueUIClass = GetRiskAlertClass(riskLevel),
                NewNote = new NoteDto
                {
    ...
    public string GetRiskAlertClass(ENiveauRisque niveau)
    {
        return niveau switch
        {
            ENiveauRisque.None => "alert-success",
            ENiveauRisque.Borderline => "alert-secondary",
            ENiveauRisque.EarlyOnset => "alert-danger",
            ENiveauRisque.InDanger => "alert-warning",
            _ => "alert-dark"
        };
    }
}
